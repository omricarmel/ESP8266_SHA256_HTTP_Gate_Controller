...
#define GATE_PIN 2            // connects to gate pin 16
#define PORT 80                         // tcp/ip http port
const String GATE_PASSWD = "carmelfam<3"; // To-Do: change to real password

char ssid[] = "carmelfam"; // home WiFi name
char pass[] = "12345678";  // home Wifi WPA2 password
...
int saltCount = 173421; // psudo random shared public salt
uint8_t *hash;
